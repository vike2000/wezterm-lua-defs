...
---@param args ... Value
function wezterm.log_warn(args) end

---@param args ... Value
function wezterm.log_info(args) end
...
---@return any --[[ alias cycle: Result --]]
function wezterm.enumerate_ssh_hosts(config_files) end
...
---@param args any
---@return boolean
function wezterm.emit(name, args) end
...
---@param args ... Value
function wezterm.log_error(args) end
...
---@param args ... Value
function wezterm.print(args) end
...
---@param args ... string
---@return nil
function wezterm.add_to_config_reload_watch_list(args) end
